...
class MyFavorites
{
    class func publishers() -> [Publisher]
    {
        ...
        publishers.append(Publisher.init(title: "TIME", url: "http://time.com", image: UIImage(named: "Recode")!, section: "My Favorites"))
        publishers.append(Publisher.init(title: "The New York Times", url: "http://www.nytimes.com", image: UIImage(named: "Recode")!, section: "My Favorites"))
        publishers.append(Publisher.init(title: "TED", url: "https://www.ted.com", image: UIImage(named: "Recode")!, section: "My Favorites"))
        publishers.append(Publisher.init(title: "Re/code", url: "http://recode.net", image: UIImage(named: "Recode")!, section: "My Favorites"))
        publishers.append(Publisher.init(title: "WIRED", url: "http://www.wired.com", image: UIImage(named: "Recode")!, section: "My Favorites"))
...
class Politics
{
    class func publishers() -> [Publisher]
    {
        ...
        publishers.append(Publisher(title: "The Atlantic", url: "http://www.theatlantic.com", image: UIImage(named: "TIME")!, section: "Politics"))
        publishers.append(Publisher(title: "The Hill", url: "http://thehill.com", image: UIImage(named: "TIME")!, section: "Politics"))
        publishers.append(Publisher(title: "Daily Intelligencer", url: "http://nymag.com/daily/intelligencer/", image: UIImage(named: "TIME")!, section: "Politics"))
        publishers.append(Publisher(title: "Vanity Fair", url: "http://recode.net", image: UIImage(named: "TIME")!, section: "Politics"))
        publishers.append(Publisher(title: "TIME", url: "http://time.com", image: UIImage(named: "TIME")!, section: "Politics"))
        publishers.append(Publisher(title: "The Huffington Post", url: "http://www.huffingtonpost.com", image: UIImage(named: "TIME")!, section: "Politics"))
        return publishers
    }
}
...
class Travel
{
    class func publishers() -> [Publisher]
    {
        ...
        publishers.append(Publisher(title: "The New York Times", url: "http://www.nytimes.com", image: UIImage(named: "AFAR")!, section: "Travel"))
        publishers.append(Publisher(title: "Men’s Journal", url: "http://www.mensjournal.com", image: UIImage(named: "AFAR")!, section: "Travel"))
        publishers.append(Publisher(title: "Smithsonian", url: "http://www.smithsonianmag.com/?no-ist", image: UIImage(named: "AFAR")!, section: "Travel"))
        publishers.append(Publisher(title: "Wallpaper", url: "http://www.wallpaper.com", image: UIImage(named: "AFAR")!, section: "Travel"))
        publishers.append(Publisher(title: "Sunset", url: "http://www.sunset.com", image: UIImage(named: "AFAR")!, section: "Travel"))
        return publishers
    }
}
...
class Technology
{
    class func publishers() -> [Publisher]
    {
        ...
        publishers.append(Publisher(title: "Re/code", url: "http://recode.net", image: UIImage(named: "WIRED")!, section: "Technology"))
        publishers.append(Publisher(title: "Quartz", url: "http://qz.com", image: UIImage(named: "WIRED")!, section: "Technology"))
        publishers.append(Publisher(title: "Daring Fireball", url: "http://daringfireball.net", image: UIImage(named: "WIRED")!, section: "Technology"))
        publishers.append(Publisher(title: "MIT Technology Review", url: "http://www.technologyreview.com", image: UIImage(named: "WIRED")!, section: "Technology"))
        return publishers
    }
}
